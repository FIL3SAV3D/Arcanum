...
void Camera::UpdateInput(const bool* _KeyStates)
{
	glm::vec3 temp{};

	if ( true/*glfwGetMouseButton(window, GLFW_MOUSE_BUTTON_2) == GLFW_PRESS*/)
	{
...
{
	return glm::perspective(glm::radians(45.0f), (float)screenWidth / (float)screenHeight, 0.1f, 1000.0f);
}
