...
//
//void ECSPhysicsSystem::OnCreate(StartState& _State)
//{
...
//    // malloc / free.
//    temp_allocator = std::make_shared<TempAllocatorImpl>(10 * 1024 * 1024);
//
//    // We need a job system that will execute physics jobs on multiple threads. Typically
//    // you would implement the JobSystem interface yourself and let Jolt Physics run on top
//    // of your own job scheduler. JobSystemThreadPool is an example implementation.
//    job_system = std::make_shared<JobSystemThreadPool>(cMaxPhysicsJobs, cMaxPhysicsBarriers, thread::hardware_concurrency() - 1);
//
...
//}
//
//void ECSPhysicsSystem::OnStart(StartState& _State)
//{
//    std::shared_ptr<Coordinator> coordinator = _State.coordinator;
//
//    glm::vec3 scale{};
//    glm::quat rotation{};
...
//
//        physics_system->GetBodyInterface().SetPositionAndRotation(rigidBody.ID, JPH::Vec3(transform.transform[3].x, transform.transform[3].y, transform.transform[3].z), JPH::Quat(rotation.x, rotation.y, rotation.z, rotation.w), JPH::EActivation::Activate);
//    }
//}
//
//void ECSPhysicsSystem::OnUpdate(GameState& _State, const float& _DeltaTime)
//{
//    std::shared_ptr<Coordinator> coordinator = _State.coordinator;
//
//    physics_system->Update(_DeltaTime, 1, temp_allocator.get(), job_system.get());
//
//    JPH::Vec3 position{};
//    JPH::Quat rotation{};
//
