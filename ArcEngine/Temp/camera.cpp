...
namespace arc
{
	void arcCamera::setOrthographicProjection(
	...
	void arcCamera::setPerspectiveProjection(float fovy, float aspect, float near, float far) {
	...
	void arcCamera::setViewDirection(glm::vec3 position, glm::vec3 direction, glm::vec3 up) {
	...
	void arcCamera::setViewTarget(glm::vec3 position, glm::vec3 target, glm::vec3 up) {
		setViewDirection(position, target - position, up);
	}

	void arcCamera::setViewYXZ(glm::vec3 position, glm::vec3 rotation) {
